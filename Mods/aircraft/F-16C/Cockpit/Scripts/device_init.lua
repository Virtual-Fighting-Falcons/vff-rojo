...
creators[devices.ROJO_SMOKE_SYSTEM] = {
	"avSimpleWeaponSystem",
	LockOn_Options.script_path.."Rojo/RojoSmokeSystem.lua"
}
...
{
	"ccIndicator",
	LockOn_Options.script_path.."Displays/VFF/Stopwatch/Indicator/init.lua",
	nil,
	{
		{
			"PTR-HUD-CENTER",
...
{
	"ccIndicator",
	LockOn_Options.script_path.."Displays/VFF/SmokeController/init.lua",
	nil,
	{
		{
			"PTR-HUD-CENTER",
