...
-- Rojo--- ----------------------------------
---------------------------------------------
{   down = 6001, name = _('Rojo On'), category = {_('Rojo Smoke')}},
{   down = 6002, name = _('Rojo Off'), category = {_('Rojo Smoke')}},
{   down = 6003, name = _('Smoke On'), category = {_('Rojo Smoke')}},
{   down = 6004, name = _('Smoke Off'), category = {_('Rojo Smoke')}},
{   down = 6005, name = _('Smoke Toggle'), category = {_('Rojo Smoke')}},
